...
// ============================================================================
// (removido) exportInemaCompliancePDF/InemaComplianceRow — gerador antigo baseado
// em inema_permits, sem uso. O PDF do INEMA hoje é o InemaReport.exportPDF, que lê
// de water_permits. Mantido fora para não haver ambiguidade de "qual gerador".
