...
ALTER TABLE public.equipments
  ADD COLUMN IF NOT EXISTS participates_night_cycle BOOLEAN NOT NULL DEFAULT TRUE;

-- 2) Redefine calculate_energy_efficiency_pumps_for_date sem filtro de automation_schedules
...
-- 3) Redefine get_energy_efficiency_summary sem filtro de automation_schedules
