-- Atualiza protocolo de polling: sempre enviar 1 dígito (0 ou 1), nunca {} vazio.
-- Cada equipamento tem uma "saída" no PLC; o polling apenas reafirma o estado
-- desejado dessa saída individualmente.
...
BEGIN
  ...
  LOOP
    ...
    -- Sempre 1 dígito refletindo estado desejado da saída desta bomba
