...
GRANT SELECT ON public.authorship_reconciliation_batches TO authenticated;
GRANT ALL ON public.authorship_reconciliation_batches TO service_role;
...
GRANT SELECT ON public.remote_reconciliation_queue TO authenticated;
GRANT ALL ON public.remote_reconciliation_queue TO service_role;
...
BEGIN
  ...
  RETURN n;
END; $$;
GRANT EXECUTE ON FUNCTION public.apply_remote_reconciliation(uuid, uuid, uuid[], uuid, text) TO authenticated, service_role;