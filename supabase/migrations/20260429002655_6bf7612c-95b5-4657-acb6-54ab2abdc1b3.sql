...
BEGIN
  ...
  LOOP
    ...
    -- Se estamos na janela de 60s e a bomba ecoou o estado oposto ao esperado,
    -- mantemos o bit antigo no last_outputs_state (UI continua "Ligando…" /
    -- "Desligando…"). Os demais bits do payload (outras saídas do mesmo PLC)
    -- ficam atualizados normalmente. Como não trocamos o bit, o estado NÃO é
    -- considerado mudado neste tick.
    ...
    SET
      ...
      last_outputs_state = COALESCE(v_payload_to_store, last_outputs_state),
