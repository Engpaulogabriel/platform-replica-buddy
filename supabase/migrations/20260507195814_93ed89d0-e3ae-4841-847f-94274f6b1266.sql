...
BEGIN
  ...
  -- v3.9.8: TSNN pode ser hex (ex: 11A5). Normaliza para uppercase para
  -- lookup case-insensitive contra hw_id (que sempre é uppercase no banco).
  ...
  FOR v_eq IN
    ...
    WHERE farm_id = _farm_id
      AND upper(substring(hw_id from 1 for 4)) = v_tsnn_norm  -- v3.9.8: case-insensitive
