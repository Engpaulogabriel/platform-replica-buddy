...
CREATE TABLE IF NOT EXISTS public.automation_cleanup_audit (
  ...
  farm_id        uuid,
  equipment_id   uuid,
  phase_a_category text      NOT NULL,
...
GRANT SELECT ON public.automation_cleanup_audit TO authenticated;
GRANT ALL ON public.automation_cleanup_audit TO service_role;
...
BEGIN
  ...
  SELECT a.run_id, a.event_id, a.farm_id, a.equipment_id, a.phase_a_category, 'restored',
