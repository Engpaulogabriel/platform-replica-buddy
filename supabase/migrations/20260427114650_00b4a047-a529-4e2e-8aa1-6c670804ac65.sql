...
BEGIN
  ...
  LOOP
    ...
    SET status = 'cancelled',
        responded_at = now(),
        error_message = 'Bomba offline > 15 min — comando de ligar cancelado para evitar religamento automatico'
    ...
    VALUES (
      ...
      'warn',
      'safety',
      format('Bomba %s ficou offline > 15 min com comando de ligar ativo — comando cancelado e desired_running zerado. Sera necessario reenviar comando manual quando voltar a comunicacao.', v_eq.name)
    );
