...
BEGIN
  ...
  FOR v_pos IN 1..v_max_saida LOOP
    ...
    IF FOUND THEN
      -- Fonte única da verdade para polling:
      -- desired_running é atualizado pelo comando web, acionamento local válido e safety.
      -- Nunca buscar comando manual antigo em public.commands para decidir payload.
