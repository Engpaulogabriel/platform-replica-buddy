...
BEGIN
  ...
  LOOP
    ...
    ELSE
      ...
      INSERT INTO public.authorship_pending_review (farm_id, automation_log_id)
      VALUES (r.farm_id, r.id) ON CONFLICT (automation_log_id) DO NOTHING;
      v_q := v_q + 1;
    END IF;
  END LOOP;
...
BEGIN
  ...
  SELECT array_agg(q.automation_log_id) INTO v_ids
