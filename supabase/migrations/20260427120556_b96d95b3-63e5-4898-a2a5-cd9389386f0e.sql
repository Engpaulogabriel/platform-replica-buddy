...
BEGIN
  ...
  LOOP
    ...
    ELSE
      ...
      -- Cenário NOVO: comando manual de LIGAR foi enviado, bomba responde 0 fora da janela inicial
      -- (ou seja, não obedeceu) → marca LOCAL imediatamente, mesmo antes dos 180s.
