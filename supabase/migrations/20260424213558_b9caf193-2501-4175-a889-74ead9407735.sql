...
DROP TRIGGER IF EXISTS trg_guard_unexpected_pump_shutdown ON public.equipments;

CREATE TRIGGER trg_guard_unexpected_pump_shutdown
AFTER UPDATE OF last_outputs_state, desired_running, pending_command_id, last_actuation_origin
ON public.equipments
FOR EACH ROW
EXECUTE FUNCTION public.guard_unexpected_pump_shutdown();