...
BEGIN
  ...
  -- Janela crítica: se existe comando remoto recente de LIGAR para esta bomba,
  -- a leitura 0 ainda é apenas confirmação de que ela não ligou imediatamente.
  -- Não pode gerar TX 0 local_shutdown/local_startup antes dos 60s de tolerância.
...
BEGIN
  ...
  LOOP
    ...
    -- ainda protege o comando remoto de LIGAR recente contra leituras 0 nos 60s iniciais.
