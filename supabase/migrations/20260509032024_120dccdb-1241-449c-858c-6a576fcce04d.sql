...
BEGIN
  -- Conta como ativa toda bomba REALMENTE ligada (estado real RX em last_outputs_state)
  -- ou que tenha desired_running=true (caso ainda não tenha chegado RX).
  SELECT
    count(*) FILTER (
